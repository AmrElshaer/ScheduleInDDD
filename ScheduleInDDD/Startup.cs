...
using ScheduleInDDD.Infrastructure;
using ScheduleInDDD.Api.Hubs;
...
namespace ScheduleInDDD
{
    public class Startup
    {
        ...
        public void ConfigureServices(IServiceCollection services)
        {
            ...
            services.AddSingleton<IPooledObjectPolicy<RabbitMQ.Client.IModel>, RabbitModelPooledObjectPolicy>();
        }
